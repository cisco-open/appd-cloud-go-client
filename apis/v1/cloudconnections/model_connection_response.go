...
func NewConnectionResponse(details ConnectionResponseDetails, id string, createdAt time.Time, updatedAt time.Time, state string, stateMessage map[string]interface{}, displayName string, type_ ProviderType) *ConnectionResponse {
