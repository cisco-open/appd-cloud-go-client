...
type ConnectionDetail struct {
	...
	StateMessage map[string]interface{} `json:"stateMessage"`
}
...
func NewConnectionDetail(id string, createdAt time.Time, updatedAt time.Time, state string, stateMessage map[string]interface{}, displayName string, type_ ProviderType) *ConnectionDetail {
