...
func (r ApiDeleteConnectionRequest) Execute() (*ConnectionResponse, *http.Response, error) {
...
// Execute executes the request
//  @return ConnectionResponse
func (a *ConnectionsApiService) DeleteConnectionExecute(r ApiDeleteConnectionRequest) (*ConnectionResponse, *http.Response, error) {
	var (
