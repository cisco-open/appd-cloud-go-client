...
type NullableBaseClientRequest struct {
	value *BaseClientRequest
	isSet bool
}

func (v NullableBaseClientRequest) Get() *BaseClientRequest {
	return v.value
}

func (v *NullableBaseClientRequest) Set(val *BaseClientRequest) {
	v.value = val
	v.isSet = true
}
...
func NewNullableBaseClientRequest(val *BaseClientRequest) *NullableBaseClientRequest {
	return &NullableBaseClientRequest{value: val, isSet: true}
}
