...
func (v NullableInvalidFilterError) Get() *InvalidFilterError {
	return v.value
}

func (v *NullableInvalidFilterError) Set(val *InvalidFilterError) {
	v.value = val
	v.isSet = true
}
...
func NewNullableInvalidFilterError(val *InvalidFilterError) *NullableInvalidFilterError {
	return &NullableInvalidFilterError{value: val, isSet: true}
}
