...
// APIClient manages communication with the Application Principal Management Service API v1.0
...
func (c *APIClient) prepareRequest(
	...
	if ctx != nil {
		...
		if tok, ok := ctx.Value(client.ContextOAuth2).(oauth2.TokenSource); ok {
		...
		if auth, ok := ctx.Value(client.ContextBasicAuth).(client.BasicAuth); ok {
